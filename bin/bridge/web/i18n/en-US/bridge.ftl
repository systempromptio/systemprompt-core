...
sync-elevation-required = Sync finished, but { $count } agent(s) need administrator approval: { $hosts }.
...
rail-profile-disconnect = Disconnect this computer…
rail-profile-purge = Reset Bridge completely…
rail-profile-remove-application = Remove Bridge application…
