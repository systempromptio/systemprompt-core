...
## Command
```
systemprompt --non-interactive logs trace view test-trace-id
```
...
⚠ No events found for trace_id: test-trace-id
ℹ Tip: The trace may take a moment to populate. Try again in a few seconds.
```
