...
- Routes generated by `admin config gateway route add` and by `admin setup` declare no governance requirement (`requires: None`), leaving residency enforcement to profiles that ask for it.
