//! Interactive startup renderer consuming phase/service events.
//!
...
impl StartupRenderer {
    ...
    fn handle_phase_event(&mut self, event: StartupEvent) -> Option<StartupEvent> {
        match event {
    ...
    fn handle_service_event(&mut self, event: StartupEvent) -> Option<StartupEvent> {
        match event {
    ...
    fn handle_status_event(&mut self, event: StartupEvent) -> Option<StartupEvent> {
        match event {
    ...
    fn handle_terminal_event(&mut self, event: StartupEvent) -> bool {
        match event {
