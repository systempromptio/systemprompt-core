...
async fn execute_internal(
    ...
    let output = CostSummaryOutput {
        ...
        reasoning_tokens: current.reasoning_tokens.unwrap_or(0),
        cache_read_tokens: current.cache_read_tokens.unwrap_or(0),
        cache_creation_tokens: current.cache_creation_tokens.unwrap_or(0),
