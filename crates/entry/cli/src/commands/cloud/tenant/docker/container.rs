...
pub(crate) fn is_shared_container_running() -> bool {
...
pub(crate) fn get_container_password() -> Option<String> {
    let output = Command::new("docker")
        .args([
            "inspect",
...
pub(crate) fn check_volume_exists() -> bool {
    let output = Command::new("docker")
        .args([
            "volume",
            "ls",
...
pub(crate) fn remove_shared_volume() -> Result<()> {
...
pub(crate) fn stop_shared_container() -> Result<()> {
...
pub(crate) fn generate_shared_postgres_compose(password: &str, port: u16) -> String {
    format!(
...
pub(crate) fn generate_admin_password() -> String {
...
#[must_use]
pub(crate) fn new_local_tenant_id() -> String {
