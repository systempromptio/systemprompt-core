//! Tenant name/config validation for cloud commands.
//!
...
pub(super) struct BuildValidationResult {
...
pub(super) fn validate_build_ready() -> Result<BuildValidationResult> {
    let project_root =
...
pub(super) fn warn_required_secrets(required_secrets: &[String]) {
