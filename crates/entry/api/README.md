...
Composes Axum routes and middleware for authentication, agents, MCP, inference, marketplace, analytics and administration. Enforcement and authentication requirements are specific to each route.
