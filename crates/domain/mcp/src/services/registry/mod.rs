...
pub fn export_registry_servers() -> Result<Vec<ServerManifest>> {
...
pub fn export_enabled_servers() -> Result<Vec<(ServerManifest, u16)>> {
    RegistryService::get_enabled_servers()
}
