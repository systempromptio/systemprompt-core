...
- **Breaking**: `issue_cowork_access_with` mints `audience: vec![JwtAudience::Cowork]` instead of `JwtAudience::Api`. A cowork JWT no longer authorises generic API endpoints.
