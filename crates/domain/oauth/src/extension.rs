    ...
    fn schemas(&self) -> Vec<SchemaDefinition> {
        vec![
            SchemaDefinition::inline(
                "oauth_clients",
                include_str!("../schema/oauth_clients.sql"),
            )
            ...
            .with_required_columns(vec!["id".into(), "client_id".into(), "redirect_uri".into()]),
            SchemaDefinition::inline(
                "oauth_client_grant_types",
                include_str!("../schema/oauth_client_grant_types.sql"),
            )
            .with_required_columns(vec!["id".into(), "client_id".into(), "grant_type".into()]),
            SchemaDefinition::inline(
                "oauth_client_response_types",
                include_str!("../schema/oauth_client_response_types.sql"),
            )
            .with_required_columns(vec!["id".into(), "client_id".into(), "response_type".into()]),
            SchemaDefinition::inline(
                "oauth_client_scopes",
                include_str!("../schema/oauth_client_scopes.sql"),
            )
            .with_required_columns(vec!["id".into(), "client_id".into(), "scope".into()]),
            SchemaDefinition::inline(
                "oauth_client_contacts",
                include_str!("../schema/oauth_client_contacts.sql"),
            )
            .with_required_columns(vec!["id".into(), "client_id".into(), "contact".into()]),
            SchemaDefinition::inline(
                "oauth_auth_codes",
            ...
            .with_required_columns(vec!["token".into(), "client_id".into(), "user_id".into()]),
            SchemaDefinition::inline(
