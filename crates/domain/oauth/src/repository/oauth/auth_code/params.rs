...
/// Inputs to [`super::OAuthRepository::mint_authorization_code`]. Unlike
/// [`AuthCodeParams`], the code itself is generated by the mint, and `scope:
/// None` selects the deployment's default roles.
#[derive(Debug, Clone, Copy)]
pub struct MintAuthCodeParams<'a> {
    pub client_id: &'a ClientId,
    pub user_id: &'a UserId,
    pub redirect_uri: &'a str,
