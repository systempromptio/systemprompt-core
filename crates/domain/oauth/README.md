...
Implements OAuth2/OIDC, PKCE, dynamic client registration, token introspection and revocation, and WebAuthn authentication with PostgreSQL persistence.
