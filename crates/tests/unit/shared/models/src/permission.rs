//! Unit tests for [`systemprompt_models::auth::Permission`] and its
//! `permissions_to_string` / `parse_permissions` helpers.

use std::str::FromStr;
use systemprompt_models::auth::{Permission, parse_permissions, permissions_to_string};
...
#[test]
fn permissions_string_conversion() {
