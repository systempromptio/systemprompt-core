...
//! through [`CliService`] and the [`Display`]/[`display::DetailedDisplay`]
//! traits. This is one of the sanctioned `println!`/`write!`-to-stdio sinks; it
//! deliberately does not route through `tracing`. Themed colour and iconography
//! live in [`theme`].
