...
impl AgentName {
    ...
    // Why: panicking convenience constructor for static call sites where the input
    // is known-valid; clippy's expect lint is suppressed because failure here
    // is a programmer-bug invariant.
