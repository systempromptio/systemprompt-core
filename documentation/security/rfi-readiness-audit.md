...
| Gateway quotas | Ordinary gateway cost buckets account for completed requests; concurrent in-flight requests can exceed a ceiling. | Size ordinary quotas for concurrent usage |
