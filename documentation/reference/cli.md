...
Command structure is defined in `crates/entry/cli/src/runner/args/mod.rs` and the modules under `crates/entry/cli/src/commands/`.
...
These apply to every command (`crates/entry/cli/src/runner/args/mod.rs`).
