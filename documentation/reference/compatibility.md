...
|----------------------|--------|
| 0.61.x | Current supported line. |
| 0.60.x | Prior line; Critical and High fixes only. | <!-- version-ok: historical support line -->
| < 0.60 | No longer supported. | <!-- version-ok: historical support line -->
