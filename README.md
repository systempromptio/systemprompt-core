...
<details>
<summary><strong>What's new in v0.4.2</strong> — cowork sync + auth pipeline hardened</summary>

Eight-issue hardening pass shipped across Phase 0–2 (Phase 3 mTLS pending):
