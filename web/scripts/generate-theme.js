...
if (!process.env.SYSTEMPROMPT_WEB_CONFIG_PATH) {
  console.error('ERROR: SYSTEMPROMPT_WEB_CONFIG_PATH environment variable must be set');
  process.exit(1);
}
if (!process.env.SYSTEMPROMPT_WEB_METADATA_PATH) {
  console.error('ERROR: SYSTEMPROMPT_WEB_METADATA_PATH environment variable must be set');
  process.exit(1);
}
 ...
 * Generated from: $SYSTEMPROMPT_WEB_CONFIG_PATH
